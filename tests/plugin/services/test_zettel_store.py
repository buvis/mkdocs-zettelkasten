...
class TestZettelStore:
    ...
    def test_update_sorts_by_id(self) -> None:
        z1 = _make_zettel_mock(3, path=Path("/docs/c.md"))
        z2 = _make_zettel_mock(1, path=Path("/docs/a.md"))
        z3 = _make_zettel_mock(2, path=Path("/docs/b.md"))
    ...
    def test_get_by_path(self) -> None:
        z = _make_zettel_mock(1, path=Path("/docs/note.md"))
        store = ZettelStore([z])
    ...
    def test_get_by_partial_path(self) -> None:
        z = _make_zettel_mock(1, path=Path("/docs/sub/note.md"))
        store = ZettelStore([z])
    ...
    def test_partial_path_dir_segment_match(self) -> None:
        z = _make_zettel_mock(1, path=Path("/docs/dir/foo.md"))
        store = ZettelStore([z])
    ...
    def test_partial_path_rejects_wrong_dir(self) -> None:
        z = _make_zettel_mock(1, path=Path("/docs/other/foo.md"))
        store = ZettelStore([z])
