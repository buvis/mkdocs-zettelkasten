...
class ValidationService:
    ...
    def validate(
        ...
        *,
        ...
        self._check_orphans(store, backlinks)
        self._check_broken_links(broken_links)
        self._check_stale_fleeting(store)
        self._check_missing_type(store)
        self._check_broken_sequences(store)
    ...
    def _check_invalid_files(self, invalid_files: list) -> None:
    ...
    def _check_orphans(self, store: ZettelStore, backlinks: dict[int, list]) -> None:
        targeted_ids: set[int] = set(backlinks.keys())
    ...
    def _check_broken_links(self, broken_links: list[tuple[str, str]]) -> None:
    ...
    def _check_stale_fleeting(self, store: ZettelStore) -> None:
    ...
    def _check_missing_type(self, store: ZettelStore) -> None:
        for zettel in store.zettels:
    ...
    def _check_broken_sequences(self, store: ZettelStore) -> None:
        for zettel in store.zettels:
