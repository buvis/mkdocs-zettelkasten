...
!!! tip
    Install [PyMdown Extensions](https://facelessuser.github.io/pymdown-extensions/installation/) and enable `pymdownx.superfences` in `mkdocs.yml` to get syntax highlighting in code blocks nested in lists.
